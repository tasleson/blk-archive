...
use blk_archive::slab::builder::SlabFileBuilder;
use blk_archive::slab::SlabFile;
use blk_archive::stream::{self, MapEntry};
...
fn print_help() {
    ...
    println!();
    println!("Dumps stream metadata and mapping instructions from blk-archive stream files.");
    println!();
    println!("USAGE:");
